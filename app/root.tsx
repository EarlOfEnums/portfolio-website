...
import { SanityVisualEditing } from "~/components/sanity-studio";
...
export async function loader({ request }: Route.LoaderArgs) {
  const colorScheme = (await getColorScheme(request)) || "system";
  ...
  return { preview, ENV, colorScheme };
}
  ...
  return (
    ...
    >
      ...
      <body>
        ...
        <ScrollRestoration />
        <Scripts />
        {loaderData?.preview && <SanityVisualEditing />}
        <script
