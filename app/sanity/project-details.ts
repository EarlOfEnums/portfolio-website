...
invariant(process.env.VITE_SANITY_PROJECT_ID, "Sanity Project ID is required");
invariant(process.env.VITE_SANITY_DATASET, "Sanity Dataset is required");
invariant(
  process.env.VITE_SANITY_API_VERSION,
  "Sanity API Version is required"
);
invariant(process.env.VITE_SANITY_STUDIO_URL, "Sanity Studio URL is required");
